        ...
        public void Configure(EntityTypeBuilder<OfferedService> builder)
        {
            builder.HasMany(ag => ag.AgeGroups)
                   ...
                   .UsingEntity<Dictionary<string, object>>("OfferedServiceAgeGroups",
                                                            ...
                                                            b => b.HasOne<OfferedService>().WithMany().HasForeignKey("OfferedServiceId").OnDelete(DeleteBehavior.Cascade),
                                                            b =>
                                                            {
            ...
            var offeredService4 = new OfferedService { OfferedServiceId = 4, OfferedServiceName = "BrowShaping", Genders = { Gender.Male, Gender.Female }, ApproximateDuration = new TimeSpan(0, 80, 0), Price = 400, Status = true };
            var offeredService5 = new OfferedService { OfferedServiceId = 5, OfferedServiceName = "BeardGrooming", Genders = { Gender.Male, Gender.Female }, ApproximateDuration = new TimeSpan(0, 100, 0), Price = 500, Status = true };
            var offeredService6 = new OfferedService { OfferedServiceId = 6, OfferedServiceName = "ChildShave", Genders = { Gender.Male, Gender.Female }, ApproximateDuration = new TimeSpan(0, 120, 0), Price = 600, Status = true };
            var offeredService7 = new OfferedService { OfferedServiceId = 7, OfferedServiceName = "PermHair", Genders = { Gender.Male, Gender.Female }, ApproximateDuration = new TimeSpan(0, 140, 0), Price = 700, Status = false };
            var offeredService8 = new OfferedService { OfferedServiceId = 8, OfferedServiceName = "Manicure", Genders = { Gender.Male, Gender.Female }, ApproximateDuration = new TimeSpan(0, 150, 0), Price = 800, Status = false };
            var offeredService9 = new OfferedService { OfferedServiceId = 9, OfferedServiceName = "Pedicure", Genders = { Gender.Male, Gender.Female }, ApproximateDuration = new TimeSpan(0, 160, 0), Price = 900, Status = false };
            var offeredService10 = new OfferedService { OfferedServiceId = 10, OfferedServiceName = "GroomsCut", Genders = { Gender.Male }, ApproximateDuration = new TimeSpan(0, 180, 0), Price = 1000, Status = true };
            var offeredService11 = new OfferedService { OfferedServiceId = 11, OfferedServiceName = "Makeup(Bride)", Genders = { Gender.Female }, ApproximateDuration = new TimeSpan(0, 200, 0), Price = 1100, Status = false };
