...
(function (global, factory) {
    ...
    /* SLIDE UP */
    const slideUp = (target, ApproximateDuration = 500) => {
        target.style.transitionProperty = 'height, margin, padding';
        target.style.transitionApproximateDuration = `${ApproximateDuration}ms`;
        ...
        window.setTimeout(() => {
            ...
            target.style.removeProperty('transition-ApproximateDuration');
            target.style.removeProperty('transition-property');
        }, ApproximateDuration);
    };
    /* SLIDE DOWN */
    const slideDown = (target, ApproximateDuration = 500) => {
